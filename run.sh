...
echo "1. Ensure your Tor Browser is configured for X25519Kyber768Draft00:"
echo "   - In Tor Browser (or Tor Browser Alpha on Android), navigate to about:config."
echo "   - Set 'security.tls.enable_kyber' to 'true'."
echo "   (This flag may vary or be default in newer versions)."
echo "2. Access your service at the .onion address displayed above."
echo "   (You will likely see a self-signed certificate warning - this is expected; accept it.)"
echo ""
